...
function LocatingSection({ detail }: { detail: ReleaseEvidenceDetail }) {
  ...
  if (!locating) {
    return <p className="text-sm text-zinc-600">No locating record exists for this FlightLeg.</p>;
  }
...
export default async function ReleaseEvidenceDetailPage({ params }: PageProps) {
